...
namespace ProjetoFinal2Semestre.Controllers
{
    public class TipoProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TipoProdutoNome")] TipoProduto tipoProduto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipoProdutoNome")] TipoProduto tipoProduto)
        {
