...
namespace ProjetoFinal2Semestre.Controllers
{
    public class CidadeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EstadoNome,EstadoId")] Cidade cidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EstadoNome,EstadoId")] Cidade cidade)
        {
            if (id != cidade.Id)
            {
                return NotFound();
