...
namespace ProjetoFinal2Semestre.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoProdutoId"] = new SelectList(_context.TipoProduto, "Id", "TipoProdutoNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoNome,ProdutoEstoque,TipoProdutoId,FornecedorId")] Produto produto)
        {
            ...
            ViewData["TipoProdutoId"] = new SelectList(_context.TipoProduto, "Id", "TipoProdutoNome", produto.TipoProdutoId);
            return View(produto);
        }
